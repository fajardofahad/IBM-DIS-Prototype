...
function cal_popup1 (str_datetime) {
	...
	obj_calwindow = window.open(
		'_calendar_PopUP.php?datetime=' + this.dt_current.valueOf()+ '&id=' + this.id,
		'Calendar', 'width=200,height='+(this.time_comp ? 215 : 165)+
...
{
	document.forms['requestForm'].elements[fieldName].value = "";
}