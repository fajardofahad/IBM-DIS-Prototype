...
if(BusinessJustification == ""){
	...
	var CmbForm = document.forms['requestForm'].cmbForm.selectedIndex;
	var Quantity = document.forms['requestForm'].quantity.value;
	var Size = document.forms['requestForm'].size.value;
	var Color = document.forms['requestForm'].color.value;
	var Material = document.forms['requestForm'].material.value;
	var UnitOfMeasure = document.forms['requestForm'].unitOfMeasure.value;
	var Printing = document.forms['requestForm'].printing.value;
	var Attachment1 = document.forms['requestForm'].attachment1.value;
	
	if(CmbForm == 0){
		alert("Please Select form type.");
		document.forms['requestForm'].cmbForm.focus();
		exit();
	}else if(Quantity == ""){
		...
		alert("Size field must have a value.");
		document.forms['requestForm'].size.focus();
		exit();
	}else if(Color == ""){
		alert("Color field must have a value.");
		document.forms['requestForm'].color.focus();
		exit();
	}else if(Material == ""){
		alert("Material field must have a value.");
		document.forms['requestForm'].material.focus();
		exit();
	}else if(UnitOfMeasure == ""){
		alert("Unit Of Measure field must have a value.");
		document.forms['requestForm'].unitOfMeasure.focus();
		exit();
	}else if(Printing == ""){
		alert("Printing field must have a value.");
		document.forms['requestForm'].printing.focus();
		exit();
	}else if(Attachment1 == ""){
		alert("Attachment field must have a value.");
		document.forms['requestForm'].attachment1.focus();
		exit();
	}
	
	document.forms['requestForm'].action = "../dbInsert/insertPrePrintedInquiry.php";
	...
	for(z=0;z<NoOfItems;z++){
		...
		if(document.forms['requestForm'].elements['cmbFormID[]'][z].selectedIndex == 0){
			alert("Form type in Item "+(z+1)+" must have a value.");
			document.forms['requestForm'].elements['cmbFormID[]'][z].focus();
			...
			exit();
		}else if(document.forms['requestForm'].elements['sizeID[]'][z].value == ""){
			alert("Size in Item "+(z+1)+" must have a value.");
			document.forms['requestForm'].elements['sizeID[]'][z].focus();
			
			exit();
		}else if(document.forms['requestForm'].elements['colorID[]'][z].value == ""){
			alert("Color in Item "+(z+1)+" must have a value.");
			document.forms['requestForm'].elements['colorID[]'][z].focus();
			
			exit();
		}else if(document.forms['requestForm'].elements['materialID[]'][z].value == ""){
			alert("Material in Item "+(z+1)+" must have a value.");
			document.forms['requestForm'].elements['materialID[]'][z].focus();
			
			exit();
		}else if(document.forms['requestForm'].elements['unitOfMeasureID[]'][z].value == ""){
			alert("Unit Of Measure in Item "+(z+1)+" must have a value.");
			document.forms['requestForm'].elements['unitOfMeasureID[]'][z].focus();
			
			exit();
		}else if(document.forms['requestForm'].elements['printingID[]'][z].value == ""){
			alert("Printing in Item "+(z+1)+" must have a value.");
			document.forms['requestForm'].elements['printingID[]'][z].focus();
			
			exit();
		}else if(document.forms['requestForm'].elements['attachment1ID[]'][z].value == ""){
			alert("Attachment in Item "+(z+1)+" must have a value.");
...
<td width="762" align="center" valign="top">
	...
	<div  align="left" style="float:left;width:250px"><strong> Customized : Pre-Printed Request</strong></div>
	<br /><br /><br /><br />
	...
	<div  align="right" style="float:left;width:165px">* No. of items :&nbsp;&nbsp;</div>
		<?php
		  ...
		  <input type="button" name="Submit" value="Submit" onclick="JavaScript: PrePrintedSubmit();" />
	</div>
			...
			<?php
				if(!(isset($_POST['noOfItems'])) || $_POST['noOfItems'] == 1 ){
		 			echo '<br />
						...
						<div align="right" style="float:left;height:20px;width:100px;">*Form Type:&nbsp;&nbsp;</div>
						<div align="left" style="float:left;height:20px;width:145px;">
						<select name="cmbForm" id="cmbForm" >
     					   <option value="-" selected="selected">-Select Item-</option>';
						
								$sql_cmbItem = 'Select * from custom_item_category';
								$result = mysql_query($sql_cmbItem) or die(mysql_error());
						...
						<div align="right" style="float:left;height:20px;width:100px;">* Unit of&nbsp;&nbsp; Measure  :&nbsp;&nbsp;</div>
						<div align="left" style="float:left;height:20px;width:145px;"><input type="text" name="unitOfMeasure" /></div>
						<div align="left" style="float:left;height:15px;width:760px;"></div>
						
						<div align="right" style="float:left;height:20px;width:100px;">* Printing :&nbsp;&nbsp;</div>
						<div align="left" style="float:left;height:20px;width:145px;">
						  <input type="text" name="printing" />
						</div>
						<div align="right" style="float:left;height:20px;width:130px;"> * Attachment :&nbsp;&nbsp;</div>
						<div align="left" style="float:left;height:20px;width:145px;"><input type="hidden" name="MAX_FILE_SIZE1" value="2000000">
						Please provide atleast one (1) attachment
						  <input type="file" name="attachment1" /><input type="hidden" name="MAX_FILE_SIZE2" value="2000000">
					...
					echo '<br />
						...
						<div align="right" style="float:left;height:20px;width:100px;">*Form Type:&nbsp;&nbsp;</div>
						<div align="left" style="float:left;height:20px;width:145px;">
						<select name="cmbForm'.$i.'" id="cmbFormID[]" >
     					   <option value="-" selected="selected">-Select Item-</option>';
											
								for($r=0; $r<$num; $r++) {
									echo '<option value="'.$rowValue[$r].'">'.$rowValue[$r].'</option>';
								}
						...
						<div align="right" style="float:left;height:20px;width:100px;">* Size :&nbsp;&nbsp;</div>
						<div align="left" style="float:left;height:20px;width:145px;"><input type="text" name="size'.$i.'" id="sizeID[]" /></div>
						<div align="left" style="float:left;height:5px;width:760px;"></div>
						<div align="right" style="float:left;height:20px;width:100px;">* Color :&nbsp;&nbsp;</div>
						<div align="left" style="float:left;height:20px;width:145px;"><input type="text" name="color'.$i.'" id="colorID[]" /></div>
						<div align="right" style="float:left;height:20px;width:100px;">* Material :&nbsp;&nbsp;</div>
						<div align="left" style="float:left;height:20px;width:145px;"><input type="text" name="material'.$i.'" id="materialID[]" /></div>
						<div align="right" style="float:left;height:20px;width:100px;">* Unit of&nbsp;&nbsp; Measure  :&nbsp;&nbsp;</div>
						<div align="left" style="float:left;height:20px;width:145px;"><input type="text" name="unitOfMeasure'.$i.'" id="unitOfMeasureID[]" /></div>
						<div align="left" style="float:left;height:15px;width:760px;"></div>
						
						<div align="right" style="float:left;height:20px;width:100px;">* Printing :&nbsp;&nbsp;</div>
						<div align="left" style="float:left;height:20px;width:145px;">
						  <input type="text" name="printing'.$i.'" id="printingID[]" />
						</div>
						<div align="right" style="float:left;height:20px;width:130px;"> * Attachment :&nbsp;&nbsp;</div>
						<div align="left" style="float:left;height:20px;width:145px;"><input type="hidden" name="MAX_FILE_SIZE1'.$i.'" value="2000000">
						Please provide atleast one (1) attachment
						  <input type="file" name="attachment1'.$i.'" id="attachment1ID[]" /><input type="hidden" name="MAX_FILE_SIZE2'.$i.'" value="2000000">
