...
function sendMessages(requestId,requestStatus){
	...
	if(document.forms['requestForm'].messageField.value == ""){
	 ...
	 document.forms['requestForm'].messageField.focus();
		...
		document.forms['requestForm'].action = "sendMessage.php?requestID="+requestId+"&requestStats="+requestStatus;
	...
	?>
      ...
      <tr>
        <td height="103" colspan="2" align="right" valign="top"><table width="785" border="0" cellpadding="1" cellspacing="1">
          <tr>
            <td colspan="3"><h3 style="border-bottom: 1px solid #C0C0C0; margin-bottom: -5px"><strong><img src="../images/Search.png" width="29" height="27" />Search Engine</strong></h3>
            <br /></td>
            </tr>
          <tr>
            <td width="238">&nbsp;</td>
            <td colspan="2" align="right" valign="middle"><input name="Search" type="submit" id="Search" value="Search" />
              <input name="reset" type="reset" id="reset" value="Clear Form" />
              <input name="sendOutbox" type="button" id="sendOutbox" value="Send to Outbox" /></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td width="277" align="left" valign="middle">Status :
