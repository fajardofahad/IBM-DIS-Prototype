...
if($requestStatus != 4){
$update = 'Update '.$sqlTable.' set requestorCheck = 2, procurementCheck = 0 where requestNo = \''.$Rn.'\'';
$result = mysql_query($update) or die (mysql_error());
}
include('../dbInsert/history.php');

header('location: inboxInquiries.php?msg=Message for '.$Rn.' was successfuly sent.');
?>
