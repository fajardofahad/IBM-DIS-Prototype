...
if(BusinessJustification == ""){
	...
	document.forms['requestForm'].action = "../dbInsert/insertItemInquiry.php";
	...
	for(z=0;z<NoOfItems;z++){
		...
		if(document.forms['requestForm'].elements['itemsID[]'][z].value == 0){
			alert("Item in Item "+(z+1)+" must have a value.");
			document.forms['requestForm'].elements['itemsID[]'][z].focus();
...
<td width="762" align="center" valign="top">
	...
	<div  align="left" style="float:left;width:250px"><strong> Customized : Item Request</strong></div>
	<br /><br /><br /><br />
			...
			<?php
				if(!(isset($_POST['noOfItems'])) || $_POST['noOfItems'] == 1 ){
		 			echo '<br />
						...
						<div align="right" style="float:left;height:20px;width:100px;"></div>
						<div align="left" style="float:left;height:20px;width:145px;"></div>
					...
					echo '<br />
						...
						<div align="right" style="float:left;height:20px;width:100px;">* Item :&nbsp;&nbsp;</div>
						<div align="left" style="float:left;height:20px;width:145px;">
                          <input type="text" name="items'.$i.'" id="itemsID[]" />
</div>
						<div align="right" style="float:left;height:20px;width:100px;">* Quantity :&nbsp;&nbsp;</div>
						...
						<div align="right" style="float:left;height:20px;width:100px;">* Color :&nbsp;&nbsp;</div>
						<div align="left" style="float:left;height:20px;width:145px;">
						  <input type="text" name="color'.$i.'" id="colorID[]" />
						</div>
						<div align="right" style="float:left;height:20px;width:100px;">* Material :&nbsp;&nbsp;</div>
						...
						<div align="right" style="float:left;height:20px;width:130px;"> * Attachment :&nbsp;&nbsp;</div>
						<div align="left" style="float:left;height:20px;width:145px;"><input type="hidden" name="MAX_FILE_SIZE1'.$i.'" value="2000000" id="MAX_FILE_SIZE1ID[]">
						Please provide atleast one (1) attachment
						  <input type="file" name="attachment1'.$i.'" id="attachment1ID[]" /><input type="hidden" name="MAX_FILE_SIZE2'.$i.'" value="2000000" id="MAX_FILE_SIZE2ID[]">
